...
In addition to the critical items, there were 14 filler chapters, which had content similar to the critical chapters but with explicit quantifiers (\emph{most}, \emph{all}, \emph{none}) to predicate properties of categories. 
