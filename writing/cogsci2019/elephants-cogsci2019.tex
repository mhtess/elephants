...
At this point, quantificational accounts (such as that of \citeNP{Cohen1999} where a generic ``Ks F'' means roughly that \emph{most of the relevant Ks F}) appeal to a mechanism to implicitly restrict the ``relevant'' set of robins to be females in the case of a property concerning reproduction. 
...
With prior knowledge suggesting against the existence of international elephants, the mode of \citeA{Tessler2019:genLang} interprets ``Elephants live in Africa and Asia” as meaning that some elephants live in Africa and that different ones live in Asia. 
