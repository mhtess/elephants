...
The first is a pilot experiment that tests the ME predictions that ``Elephants live in Africa and Asia'' means roughly that half live in Africa and half live in Asia as well as validates the gating procedure we will employ in the main experiment. 
The main experiment is a pre-registered study that uses the gating paradigm to test the fine-grained incremental predictions of the model.
...
The story book consisted of a total of 21 chapters, which included 8 examples of the mutually exclusive conjunctions (4 interrupted, 4 uninterrupted; Conditions 1A and 1B) and 4 examples of the nonmutually exclusive conjunctions (2 interrupted; 2 uninterrupted; Conditions 1C and 1D); in addition, there were 8 filler trials involving quantifiers (4 interrupted, 4 uninterrupted). 
The experiment began with 2 filler trials and no two critical trials were back-to-back. 
...
The critical trial materials were the same as those used in the pilot experiment; the fillers were modified to introduce page breaks immediately before and immediately after conjunctions (the word ``and''). 
