...
A different pattern was observed for the non-mutually exclusive properties, where hearing about the second property only increased participants' degree of belief in each property applying.
...
It is notable that in this condition, participants on average infer a greater than 50\% prevalence for \emph{Africa} and lower than 50\% for \emph{Asia}.
This  difference from Expt.~1 may result the fact that asking participants about \emph{Asia} (as in Expt.~1), the question could remind participants that they learned something about Asia. 
This memory effect might be further exaggerated by the fact that the conjunctions always occurred across page breaks, and thus participants saw the phrase ``live in Africa'' and the phrase ``and Asia'' at different moments, which may lead to decreased memory representation for ``live in Africa''.
}
