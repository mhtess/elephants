...
\geometry{hmargin={0.75in,0.75in},vmargin={0.75in,0.75in}}
...
\begin{document}
\begin{center}
\textbf{Non-monotonic understanding of conjunctive generic sentences}
\end{center}
...
To explore these ideas, we extend a Rational Speech Act model for interpreting generic language to incorporate an incremental processing mechanism that allows a listener to understand partial utterances.
...
\vspace{-1cm}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{incremental}
  \end{center}
  \vspace{-0.45cm}
...
%\vspace{-1cm}
  \begin{center}
    \includegraphics[width=01\textwidth]{xprag}
  \end{center}
  \vspace{-0.55cm}
