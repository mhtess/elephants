// STREAMLINED/AUGMENTED VERSION OF STIMS-7.JS TO MODULATE SYNTACTIC EXPECTATIONS
// We need mutually exclusive and non-mutually exclusive continuations for each type of coordination (may need to increase the number of stims). (fillers or criticals or both?)
...
// type = filler (is a proper subset of what we actualy consider "filler" trials)
var filler_chapters = [
    {
...
// type = critical (intersects the set of what we consider "filler" trials)
var stims_chapters = [
    {
	title: "Religion",
	main_text: [
