...
var stims_chapters = [
  {
    ...
    main_text: [
      ...
      "of the seven continents, and all of them are highly spiritual. They ascribe to the Caboo religion and "
    ],
    continuation: {
  ...
  },
  {
	...
	"sixty years. They live on the southern continent of Caro and "
    ],
    continuation: {
      critical: "on the northern continent of Este.",
  ...
  },
  {
    ...
    main_text: [
      "Mooks are ferocious creatures that live on the continent of Benli. Benli has dramatic elevation changes ",
	    ...
	    "of survival. Mooks have territories at the tops of tall mountains and ",
    ],
    // continuation: {
    ...
    // },
    continuation: {
      critical: "at the bottom of deep canyons.",
      filler: "one would be wise to keep their distance from them."
    },
    critical: true,
    kind: "mooks",
  ...
  },
  {
    ...
    main_text: [
      ...
      "several miles in every direction. During the springtime, the aliens flood their fields to plant fujusi and "
    ],
    continuation: {
      critical: "burn their fields to plant soroneeks.",
  ...
  },
  {
    ...
    main_text: [
      ...
      "courtship. The mated pairs use these twigs and leaves to build their quite elaborate nests in gluers and "
    ],
    continuation: {
      critical: "in droops.",
  ...
  },
  {
    ...
    main_text: [
      ...
      "large antlers, are a resource for the Krens. Stups roam all over the windy highlands of Dax, far from the sea. Krens are stup-herders and "
  ...
  },
  {
    ...
    main_text: [
      ...
      "are quite different in what kinds of animals are available for them to eat. Lorches have long wings and "
    ],
    continuation: {
      critical: "short wings.",
  ...
  },
  {
    ...
    "special headgear to help identify their owners. Around their heads, they wear giant wutsats and "
    ],
    continuation: {
      critical: "krevnors.",
  ...
  },
  {
    ...
    main_text: [
      ...
      "hunting at night they look for creatures sleeping alone, not in groups. Before they go hunting, the kweps chew on xorfun and "
    ],
    continuation: {
      critical: "on tunkel.",
      filler: "jump up and down in circles."
    },
    // continuation: {
  ...
  },
  {
    ...
    main_text: [
      ...
      "ollers find it very exciting to be on land, but they have trouble walking and need to be carried by family members. While on land, ollers carry their young in guklags and "
    ],
    // continuation: {
    ...
    // },
    continuation: {
      critical: "in trullets.",
      filler: "are very protective."
    },
    critical: true,
    kind: "oller families",
    ...
    main_text: [
      ...
      "make themselves known, crafters join guilds with other crafters of the same trade. Basket weavers are part of the Tinno guild and "
    ],
    continuation: {
	critical: "the Farza guild.",
      filler: "sell their baskets in the Warfi marketplace."
    },
    critical: true,
    kind: "basket weavers",
	...
	main_text: [
	    ...
	    "wings that are light but powerful. Batozes have six wings and "
	],
	continuation: {
	    critical: "seven wings.",
	    filler: "three eyes."
	},
	critical: true,
	kind: "batozes",
	...
	main_text: [
	    ...
	    "among the plants on the forest floor. Kaples have striped fur and "
	],
	continuation: {
	    critical: "spotted fur.",
	    filler: "long tails."
	},
	critical: true,
	kind: "kaples",
	...
	main_text: [
	    ...
	    "backs. Landeks have four horns and "
	],
	continuation: {
	    critical: "seven horns.",
	    filler: "two tails."
	},
	critical: true,
	kind: "landeks",
	...
	main_text: [
	    ...
	    "starting a new colony. Vimble queens hibernate in fallen logs and "
	],
	continuation: {
	    critical: "in the abandoned burrows of other animals.",
	...
	main_text: [
	    ...
	    "cultivate isooms for food. Isooms produce fruit with bumpy skin and "
	],
	continuation: {
	    critical: "fruit with smooth skin.",
